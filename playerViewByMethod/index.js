...
export default class VlCPlayerViewByMethod extends Component {
  ...
  static defaultProps = {
    ...
    vipEndViewText: {
      vipEndText: "End of trial",
      boughtBtnText: "Please watch after purchase",
    },
    chapterText: "chapter",
    autoplay: false,
    showAd: false,
    ...
    initAdType: 2,
    initAdOptions:
      Platform.OS === "ios" ? ["--input-repeat=1000", "--repeat"] : [],
    initType: 1,
    initOptions: [],
  ...
  changeVideoAspectRatio = (ratio) => {
    this.vlcPlayerViewRef &&
      this.vlcPlayerViewRef.changeVideoAspectRatio(ratio);
    this.vlcPlayerViewAdRef &&
      this.vlcPlayerViewAdRef.changeVideoAspectRatio(ratio);
  };
  ...
  getNoNetInfoView = () => {
    ...
    return (
      <View style={[styles.loading, { zIndex: 999, backgroundColor: "#000" }]}>
        <View
          style={[styles.backBtn, { position: "absolute", left: 0, top: 0 }]}
        >
          {(isFull || showBack) && (
            <TouchableOpacity
              onPress={this._onLeftPress}
        ...
        <View style={styles.centerContainer}>
          ...
          >
            {/* <Icon name={"reload"} size={20} color="#fff" /> */}
            <Text style={styles.centerContainerBtnText}>
    ...
    return (
      ...
      >
        ...
        <View
          style={[
            styles.ad,
            { position: "absolute", right: 0, top: 10, zIndex: 999 },
          ]}
        >
          <TimeLimt
            //maxTime={30}
        ...
        >
          {/* <Icon
            name={adMuted ? "volume-off" : "volume-high"}
            size={22}
            color="#fff"
          /> */}
        </TouchableOpacity>
          ...
          >
            ...
            {showVideo && (
              <VLCPlayerView
                ...
                isEndAd={isEndAd}
                style={
                  showAd && !isEndAd ? { position: "absolute", zIndex: -1 } : {}
                }
                videoAspectRatio={currentVideoAspectRatio}
